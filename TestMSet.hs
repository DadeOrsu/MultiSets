...
main = do
  ...
  putStrLn $ "i. Multisets m1 and m4 are not equal: " ++ show (m1 == m4)
  putStrLn $ "   but they have the same elements: " ++ show (elems m1 == elems m4)
  -- ii. Multiset m1 is equal to the union of multisets m2 and m3
  let unionM2M3 = union m2 m3
  ...
  putStrLn "Multisets m1 and m4 written to files anag-out.txt and gana-out.txt, respectively."